...
class UserProfile extends Component {
    ...
    getdta = () => {
        ...
        axios({
            method: "post",
            url: "http://localhost:3000/usrget",
            data: dta,
           // config: { headers: { "Content-Type": "multipart/form-data" } }
          })
            .then((response) => {
            ...
            let rspdat = JSON.stringify(response.data.data);

                alert(rspdat);
              
               alert(response.data.data[0].FullName.FirstName);
               alert(response.data.data[0].FullName.MiddleName);
               alert(response.data.data[0].FullName.LastName);
                 alert(JSON.stringify(response.data.data[0].Address));
            // alert(response.data.data[0].FullName.Adress.SocietyName);
            //    alert(response.data.data[0].FlatNumber);
            //    alert(response.data.data[1].Adress.SocietyName);
            //    alert(response.data.data[1].Adress.AreaName);
            //    alert(response.data.data[3]);


               // alert(response.data.data[0].FullName.FirstName);
               // this.setState({FlatNumber: "test"});
             ...
             //  alert(response.data);
                ...
                //     SocietyName: response.data.data.SocietyName,
                ...
                //     PhysicalDisability: response.data.data.PhysicalDisability,
                //     MaritalStatus: response.data.data.MaritalStatus,
                //     Education: response.data.data.Education,
                //     BirthSign: response.data.data.BirthSign,
